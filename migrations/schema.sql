...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_widgets_id_fk` FOREIGN KEY (`widget_id`) REFERENCES `teas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-07-22 16:35:28
